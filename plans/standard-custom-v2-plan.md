...
- Child spawn claims pending→starting before any await. Routing is resolved before spawn; attach is a sync CAS. Stop/Skip refuse `starting`. Failed-child reconcile is CAS on status+child id.
